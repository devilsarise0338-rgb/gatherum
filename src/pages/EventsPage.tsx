...
export default function EventsPage() {
  ...
  useEffect(() => {
    async function fetchEvents() {
      ...
      if (!upcoming) q = q.lt('start_time', new Date().toISOString());
      else q = q.gte('start_time', new Date(Date.now() - 86400000).toISOString());
      ...
      <div className="container" style={{ padding: '2rem 1.5rem' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            <button
              className={`btn btn-sm ${upcoming ? 'btn-primary' : 'btn-ghost'}`}
